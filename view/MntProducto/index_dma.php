...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="modalmantenimiento.php">
  ...
  <body>
    ...
    <div class="br-mainpanel">
      <div class="br-pageheader pd-y-10 pd-l-20 justify-content-between">
        ...
        <div class="col col-6">
          <h3 class="display-5 text-center p-2 text-dark" style="background:yellow;">Diana Martínez Andrade</h3>
        </div>
      </div><!-- br-pageheader -->
    ...
    <script type="text/javascript" src="./mntproducto_dma.js"></script>
    <script>
